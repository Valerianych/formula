                    ...
                    {aiLoading ? (
                      ...
                      <div className="bg-[#090a0f] p-4.5 rounded-xl border border-[#212333]/70 space-y-2.5">
                        <h4 className="text-xs font-bold text-white uppercase flex items-center gap-1.5">
                          <Radio className="w-3.5 h-3.5 text-emerald-400" /> AI-комментатор готов к вопросам
                        </h4>
                        <p className="text-gray-400 text-[11px] leading-relaxed font-mono">
Задайте вопрос AI-комментатору ниже или нажмите «Обновить разбор». Если круги ещё не загружены, ответ будет построен по доступным данным сессии, погоде и Race Control.
                        </p>
                      </div>
                    )}
                  </div>
        ...
        {/* Removed non-live tabs: standings/results, FastF1 and F1DB. */}
